        ...
        <div className="relative flex w-full max-w-md flex-col justify-between p-8 text-white">
          ...
          <div className="relative z-10">
            ...
            <p className="mb-8 text-sm text-gray-300">
              We know how hard it is to be a developer. It doesn&apos;t
              have to be. Join Devvrats and explore the community,
            ...
            <div className="space-y-3">
              ...
              >
                ...
                >
                  ...
                  <path
                    fill="#FF3D00"
                    d="M6.3 14.7l6.6 4.8C14.4 16.1 18.8 12 24 12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.1 6.6 29.4 4 24 4c-7.9 0-14.7 4.6-17.7 10.7z"
                  />
                  <path
                    fill="#4CAF50"
